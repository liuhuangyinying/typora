...
![image-20201120194951376](/多线程笔记.assets/类对象存储.png)
...
![wait_notify通信](F:\typora\typora\多线程笔记.assets\wait_notify通信.png)
...
![](F:\typora\typora\多线程笔记.assets\volatile.png)
...
![编译重排序](F:\typora\typora\多线程笔记.assets\编译重排序.png)
...
<img src="F:\typora\typora\多线程笔记.assets\Java内存模型.png" style="zoom:50%;" />
...
<img src="F:\typora\typora\多线程笔记.assets\Happens-Before可见性模型.png" style="zoom:67%;" />
...
![](F:\typora\typora\多线程笔记.assets\join.png)
...
![](F:\typora\typora\多线程笔记.assets\join原理.png)
...
- 返回索引位置的值
  ...
  ![](F:\typora\typora\多线程笔记.assets\ThreadLocal堆栈关系图.png)
...
![ThreadLocal方法](F:\typora\typora\多线程笔记.assets\ThreadLocal方法.png)

ThreadLocal和Thread的类关系图

![ThreadLocal和Thread的类关系图](F:\typora\typora\多线程笔记.assets\ThreadLocal和Thread的类关系图)

### set 源码

- 初始化ThreadLocalMap数组,并使用斐波那契数列算法计算出数组下标位置,存放value

![](F:\typora\typora\多线程笔记.assets\ThreadLocal初始化.png)

set实现:

![](F:\typora\typora\多线程笔记.assets\ThreadLocal开放寻址.png)
...
<img src="F:\typora\typora\多线程笔记.assets\ReentrantLock.png" alt="第五节 理解J.U.C中的ReentrantLock" style="zoom:150%;" />
...
![IDEA使用HSDIS工具查看汇编指令](F:\typora\typora\多线程笔记.assets\IDEA使用HSDIS工具查看汇编指令.png)